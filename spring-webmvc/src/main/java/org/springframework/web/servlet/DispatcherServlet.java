...
public class DispatcherServlet extends FrameworkServlet {
	...
	protected void doService(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// <2> 当 include 请求时对 request 的 Attribute 做快照备份
	...
	/**
	 * 1.根据 request 找到Handler
	 * 2.根据 Handler 找到对应的 HandlerAdapter
	 * 3.用 HandlerAdapter 处理 Handler
	 * 4.调用 processDispatchResult处理上面处理之后的结果(包含找到View并渲染输出给用户)
	 * <p>
	...
	protected void doDispatch(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			try {
				...
				// <8> 当View为空时（比如，Handler返回值为void），根据request设置默认view
	...
	private void processDispatchResult(HttpServletRequest request, HttpServletResponse response,
		...
		// <5> 发出请求处理完成的通知，触发Interceptor的afterCompletion
		if (mappedHandler != null) {
	...
	protected void render(ModelAndView mv, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// <1> TODO 叶璠 从 request 中获得 Locale 对象，并设置到 response 中
		Locale locale =
