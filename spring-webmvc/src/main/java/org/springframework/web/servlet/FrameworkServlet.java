...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	...
	/**
	 * 在所有的bean properties设置完成之后调用，初始化WebApplicationContext
	 * <p>
	...
	protected WebApplicationContext initWebApplicationContext() {
		...
		if (wac == null) {
			...
			//如果 webApplicationContext 还没创建，则创建一个
	...
	/**
	 * 在所有bean的properties 设置完成之后以及WebApplicationContext加载完成后执行
	 * 默认为空
	 * <p>
	 ...
	 * 2.处理完后发布了ServletRequestHandleEvent消息
	 * <p>
	...
	protected final void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		// 获取 RequestContextHolder 中原来保存的RequestAttributes
	...
	/**
	 * 恢复 localeContext 和 requestAttriburtes 的值
	 *
	 * @param request
